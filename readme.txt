...
Manage payroll and HR information for your employees with PayCheckMate.
...
- Payslip generation.
- Unlimited salary head creation.
- Reports generation.
    - Payroll register.
    - Payroll ledger.
...
1. Upload the `pay-check-mate` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Configure the plugin settings by navigating to the "PayCheckMate" menu in the WordPress admin panel.

== Frequently Asked Questions ==

= Can I customize the payroll calculations? =
Yes, PayCheckMate provides customization options to configure payroll calculations according to your organization's policies.
...
PayCheckMate is released under the GPL-2.0+ license: https://www.gnu.org/licenses/gpl-3.0.en.html
