...
export const Profile = () => {
    ...
    return (
        <HOC role={UserCapNames.pay_check_mate_employee}>
            <EmployeeDetails employee_id={currentUser.employee_id} page_title={__('My Profile', 'pay_check_mate')}/>
            <div className="mt-8">
                <Card>
                    <PayrollLedger employeeId={currentUser.employee_id} pageTitle={__('My Payroll Ledger', 'pay_check_mate')}/>
                </Card>
            </div>
        </HOC>
    );
