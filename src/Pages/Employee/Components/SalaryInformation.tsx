                ...
                <div className="px-4 py-6 sm:p-8">
                    <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                            <FormInput
                                required={true}
                                label={__('Gross Salary', 'pay-check-mate')}
                                name="gross_salary"
                                id="gross_salary"
                                value={grossSalary}
                                onChange={handleFormInputChange}
                                error={formErrors.gross_salary}
                                helpText={__('Set gross salary to auto calculate basic salary and other salary heads.', 'pay-check-mate')}
                            />
                        </div>
                        <div className="sm:col-span-3">
                            <FormInput
                                required={true}
                                label={__('Basic Salary', 'pay-check-mate')}
                                name="basic_salary"
                                id="basic_salary"
                        ...
                        <div className="sm:col-span-3">
                            <FormInput
                                required={true}
                                type={'date'}
                                label={__('Active from', 'pay-check-mate')}
                                name="active_from"
                                id="active_from"
                        ...
                        <div className="col-span-full">
                            <div>
                                <h3 className="font-bold text-2xl leading-6 text-gray-600">
                                    {__('Salary in hand', 'pay-check-mate')}
                                </h3>
                                ...
                                <div className="flex items-center justify-between mt-2 border-t-2 border-gray-400 pt-2">
                                    <span className="font-bold text-xl text-gray-500">{__('Total Salary in hand', 'pay-check-mate')}</span>
