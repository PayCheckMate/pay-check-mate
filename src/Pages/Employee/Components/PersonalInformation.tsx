...
export const PersonalInformation = ({setFormData, initialValues = {} as EmployeeType, children, nextStep}: PersonalInformationPropTypes) => {
    ...
    const defaultDesignation = {
        id: 'select_one',
        name: __('Select one', 'pay_check_mate'),
    }
                    ...
                    <div className="px-4 py-6 sm:p-8">
                        <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="sm:col-span-3">
                                <FormInput
                                    required={true}
                                    label={__('First name', 'pay_check_mate')}
                                    name="first_name"
                                    id="first_name"
                            ...
                            <div className="sm:col-span-3">
                                <FormInput
                                    required={true}
                                    label={__('Last name', 'pay_check_mate')}
                                    name="last_name"
                                    id="last_name"
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-1 text-sm text-gray-500">
                                    <span onClick={() => setShowDepartmentModal(true)} className={"font-medium text-"+indigo+"-600 hover:text-"+indigo+"-500 cursor-pointer"}>
                                        {__('Create a new department', 'pay_check_mate')}
                                    </span>
                                </div>
                            </div>
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-1 text-sm text-gray-500">
                                    <span onClick={() => setShowDesignationModal(true)} className={"font-medium text-"+indigo+"-600 hover:text-"+indigo+"-500 cursor-pointer"}>
                                        {__('Create a new designation', 'pay_check_mate')}
                                    </span>
                                </div>
                            </div>
                            <div className="sm:col-span-3">
                            ...
                            <div className="sm:col-span-3">
                                <FormInput
                                    required={true}
                                    label={__('Email address', 'pay_check_mate')}
                                    name="email"
                                    id="email"
                            ...
                            <div className="sm:col-span-3">
                                <FormInput
                                    label={__('Phone number', 'pay_check_mate')}
                                    name="phone"
                                    id="phone"
                            ...
                            <div className="sm:col-span-3">
                                <FormInput
                                    label={__('Bank name', 'pay_check_mate')}
                                    name="bank_name"
                                    id="bank_name"
                            ...
                            <div className="sm:col-span-3">
                                <FormInput
                                    label={__('Bank account number', 'pay_check_mate')}
                            ...
                            <div className="sm:col-span-3">
                                <FormInput
                                    label={__('Tax number', 'pay_check_mate')}
                                    name="tax_number"
                                    id="tax_number"
                            ...
                            <div className="sm:col-span-3">
                                <FormInput
                                    required={true}
                                    type="date"
                                    label={__('Joining date', 'pay_check_mate')}
                                    name="joining_date"
                                    id="joining_date"
                            ...
                            <div className="col-span-full">
                                <Textarea
                                    label={__("Address", 'pay_check_mate')}
                                    name="address"
                                    id="address"
