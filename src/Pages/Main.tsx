    ...
    let navigations: NavigationType[] = [
        ...
        {key: 'reports', title: __('Reports', 'pcm'), href: 'reports', icon: ChartPieIcon, current: false, roles: ['pay_check_mate_accountant'],
            children: [
                ...
                {key: '[need_pro]', title: __('Loan Register (PRO)', 'pcm'), href: 'pro/loan-register', current: false, roles: ['pay_check_mate_admin', 'pay_check_mate_accountant'], icon: null, component: NeedPro},
                {key: '[need_pro]', title: __('Loan Ledger (PRO)', 'pcm'), href: 'pro/loan-ledger', current: false, roles: ['pay_check_mate_admin', 'pay_check_mate_accountant'], icon: null, component: NeedPro},
