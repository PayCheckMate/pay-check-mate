...
export const Modal = ({ setShowModal, header, children }: ModalProps) => (
    <>
        <div className="justify-center items-start py-20 lg:pl-72 sm:pl-60 flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
